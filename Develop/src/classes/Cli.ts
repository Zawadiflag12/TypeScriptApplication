...
class Cli {
  ...
  createVehicle(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        else if (answers.vehicleType === 'Trucks'){
          this.createTruck();
        } else {
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        const car = new Car(
          ...
          [frontWheel, rearWheel, frontWheel, rearWheel],
        );
  ...
  createMotorbike(): void {
    inquirer
      ...
      .then((answers) => {
        // Create Wheel instances for the front and rear wheels
        const frontWheel = new Wheel(parseInt(answers.frontWheelDiameter), answers.frontWheelBrand);
        const rearWheel = new Wheel(parseInt(answers.rearWheelDiameter), answers.rearWheelBrand);

        // Create a Motorbike instance with the Wheel instances
      ...
      .then((answers) => {
        ...
        // TODO: add statements to perform the tow action only if the selected vehicle is a truck. Call the findVehicleToTow method to find a vehicle to tow and pass the selected truck as an argument. After calling the findVehicleToTow method, you will need to return to avoid instantly calling the performActions method again since findVehicleToTow is asynchronous.
          ...
          if (selectedVehicle instanceof Truck) {
            ...
            console.log(`You must select a truck in order to tow a vehicle.`)
          }
        }
